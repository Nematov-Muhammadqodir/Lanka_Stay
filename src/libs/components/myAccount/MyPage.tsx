...
const MyPage = () => {
  ...
  const { userId: guestId, section } = router.query;
  ...
  return (
    <Stack width={"100%"} mb={10}>
      ...
      <Stack mt={1} px={2}>
          ...
          <Grid item xs={2} textAlign="right">
            {editName ? (
              <Stack justifyContent={"space-between"} gap={4}>
                ...
                <Button variant="outlined" onClick={updateGuestProfileHandler}>
                  <Typography
                    className="bold-text-medium"
                    sx={{
                      color: "primary.main",
        ...
        >
          <Grid item xs={4}>
            <Typography className="bold-text-medium">Email address</Typography>
          </Grid>
