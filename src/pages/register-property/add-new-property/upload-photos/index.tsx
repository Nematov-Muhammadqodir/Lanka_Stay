        ...
        <Stack sx={{ mt: 10, gap: 2 }}>
          ...
          <Stack sx={{ flexDirection: "row", gap: 3 }}>
                ...
                <Stack>
                  <Stack sx={{ gap: 2 }}>
                    <Typography className="small-text">
                      Choose a main photo that will make a good first impression
                    </Typography>
                    <Typography className="small-text">
                      Click and drag the photos to arrange them in the order you
                      would like guests to see them
                    </Typography>
                  </Stack>
            ...
            >
              ...
              <Typography>
                If you don’t know who took a photo, it's best to avoid using it.
                      ...
                      <Stack gap={2}>
                        ...
                        >
                          ...
                          <Stack>
                            ...
                            <Typography sx={{ color: "gray", fontSize: 15 }}>
                              ...
                              interior and exterior of your property, including
                              any living rooms, bedrooms, bathrooms, gardens,
                              the kitchen, and facilities such as the swimming
                              pool or spa. And if you’ve got a great view from
                              the window or balcony, show it off!
                            </Typography>
                          </Stack>
                        </Stack>
                        ...
                        >
                          ...
                          <Stack>
                            ...
                            <Typography sx={{ color: "gray", fontSize: 15 }}>
                              ...
                              help you capture as much of your space as possible
                              in the photos.
                            </Typography>
                          </Stack>
                        </Stack>
                        ...
                        >
                          ...
                          <Stack>
                            ...
                            <Typography sx={{ color: "gray", fontSize: 15 }}>
                              For privacy protection, make sure that your photos
                              don’t feature vehicle licence plates, tv,
                        ...
                        >
                          ...
                          <Stack>
                            ...
                            <Typography sx={{ color: "gray", fontSize: 15 }}>
                              ...
                              directions, so there’s no need to add screenshots
                              of websites or maps yourself.
                            </Typography>
                          </Stack>
                        </Stack>
...
export default withLayoutCreateAccountMain(UploadPhotos);
